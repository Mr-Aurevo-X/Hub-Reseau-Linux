...
**1.3.4** — [releases](https://github.com/Mr-Aurevo-X/Hub-Reseau-Linux/releases) · GPL-3.0-or-later · © 2026 Mr-Aurevo-X
...
wget --no-continue -O org.mraurevox.HubReseau.flatpak \
  https://github.com/Mr-Aurevo-X/Hub-Reseau-Linux/releases/download/v1.3.4/org.mraurevox.HubReseau.flatpak
flatpak install --user -y --reinstall ./org.mraurevox.HubReseau.flatpak
wget --no-continue -O INSTALLER-RACCOURCI-FLATPAK.sh \
  https://github.com/Mr-Aurevo-X/Hub-Reseau-Linux/releases/download/v1.3.4/INSTALLER-RACCOURCI-FLATPAK.sh
