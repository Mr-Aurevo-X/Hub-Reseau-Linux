...
- **Page Diag** : uniquement sur action (bouton Lancer). Ping (hôte par défaut `1.1.1.1`), DNS (`github.com`, `flathub.org`) et traceroute / mtr. Ce n'est pas de la télémétrie éditeur : les paquets partent de votre machine vers ces hôtes.
